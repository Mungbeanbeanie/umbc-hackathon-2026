...
| 2 | AI Integration | Gemini API client, prompt engineering, explanation + scaffold response parsing | pending | - | 1 | - |
...
| 6 | Polish & Demo | Loading states, error handling, extension icon, end-to-end smoke test | pending | - | 5 | - |
